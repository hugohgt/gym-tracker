...
export const ResetPasswordScreen: React.FC<ResetPasswordScreenProps> = ({ onComplete, onCancel }) => {
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6 font-sans">
      <div className="w-full max-w-sm space-y-8 animate-in fade-in duration-500">
        <div className="text-center">
          ...
          <p className="text-slate-400 font-medium uppercase tracking-widest text-[10px]">Reset Account Password</p>
        </div>

        <form onSubmit={handleReset} className="bg-slate-900 border border-slate-800 p-8 rounded-[2.5rem] shadow-2xl space-y-6">
